		...
		<div class="shell"> 
			...
			<div class="box">
				...
				<div id="form">
					...
					<?php
					$UNName = $_POST['username'];	//User entered string from unit08.php form
					$PWName = $_POST['password'];	//User entered string from unit08.php form
					$PGHead = "<h2>Login Process Failed</h2>";
					
					if (empty($UNName) || empty($PWName)) {
						echo $PGHead;
						echo "<p>Please enter your username and password to login.<br />&nbsp;<br /><form action=\"unit08.php\"><input class=\"btn-more\" type=\"submit\" value=\"Return to Login\" /></form></p>";
						...
						if ($QYRRow) {
							header('Location:unit08_Admin.php');
						} else {
							echo $PGHead;
							echo "<p>Login invalid.<br />&nbsp;<br /><form action=\"unit08.php\"><input class=\"btn-more\" type=\"submit\" value=\"Return to Login Page\" /></form></p>";
						}
