...
//								$DBConn = @mysql($DBHost, $DBUser, $DBPass, $DBName);	//Connect to the database
								...
								$QYRslt = mysql_query($QYStrg);//Query Result
									...
									if ($QYRslt === FALSE)
										...
										echo "(" . $arac . ") " . $fone . "<br />";
										echo $emil . "</p>";
										echo "<p><form action=\"unit09_AddContact.php\"><input class=\"btn-more\" type=\"submit\" value=\"Add Another Contact\" /></form></p>";
									}
					...
					<form action="unit09_AddUser.php" method="post"><input class="btn-more-nav" type="submit" value="Add Admin User" /></form><br /><br />
