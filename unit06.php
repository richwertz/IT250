...
<title>Rich Wertz || School Project Experience || IT250 Unit 6</title>
<!-- InstanceEndEditable -->
...
<div id="wrapper">
		...
		<div class="shell"> 
			...
			<div id="navigation">
				<ul>
					...
					<li> <a class="active" href="unit06.php"> Unit 6 </a></li>
	...
	<div id="slider"><!-- InstanceBeginEditable name="GrayArea" -->
		<div class="shell">
			...
			<div id="intro">
				<h2>Unit 6</h2>
				<ul>
					<li>Create a table and populate it with fields and initial values.</li>
					<li>Write a 8-10 page paper discussing each step in the process.</li>
					<li>Provide documentation and code examples of how data validation will be handled in the application.</li>
				</ul>
			</div>
			<!-- /Intro -->
			<div class="cl">&nbsp;</div>
	...
	<div id="main">
		<div class="shell">
			<!-- Box - Welcome -->
			Since this assignment was largely about theory, there is no real deliverable to show, only the raw code. And that's kind of boring.
