...
<title>Rich Wertz || School Project Experience || IT250 Unit 1</title>
<!-- InstanceEndEditable -->
		...
		<div class="shell"> 
			...
			<div id="navigation">
				<ul>
					...
					<li> <a class="active" href="unit01.php"> Unit 1 </a></li>
	...
	<div id="slider"><!-- InstanceBeginEditable name="GrayArea" -->
		<div class="shell">
			...
			<div id="intro">
				<h2>Unit 1</h2>
				<ul>
					<li>Install the WAMP Software.</li>
					<li>Create a simple script to display your name using the Echo command.</li>
				</ul>
<p>&nbsp; </p>
			</div>
			<!-- /Intro -->
		...
		<div class="shell">
			...
			<div class="box">
				<h2>Deliverable</h2>
					<div id="form">
					<?php
						echo"<p>My full name is:<br />Richard Wertz</p>";
					?>
					</div>
			</div>
