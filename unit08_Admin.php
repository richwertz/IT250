...
<div id="wrapper">
	...
	<div id="main">
		<div class="shell"> 
			<!-- Box - Welcome -->
			<div class="box">
				<h2>Contacts Database - Administration</h2>
				<div id="form">
					<table>
					
					<tr><th>Database Admin Tasks</th></tr>
					
					<tr><th>
					<form action="unit08_ViewContactList.php" method="post"><input class="btn-more-nav" type="submit" value="View Contacts" /></form><br /><br />
					<form action="unit08_AddContact.php" method="post"><input class="btn-more-nav" type="submit" value="Add A Contact" /></form><br /><br />
					<form action="unit08_AddUser.php" method="post"><input class="btn-more-nav" type="submit" value="Add An Admin User" /></form><br /><br />
					<form action="unit08.php" method="post"><input class="btn-more-nav" type="submit" value="Log Out" /></form>
					</th></tr>
