			...
			<div class="box">
				...
				<div id="form">
					...
					if(!isset($_POST['login'])) {
						...
						echo $PGFail;
						echo "<p>You must be an authorized user to view this page.<br />&nbsp;<br /><form action=\"unit10.php\"><input class=\"btn-more\" type=\"submit\" value=\"Return to Login\" /></form></p>";
					...
					if (empty($UNName) || empty($PWName)) {
						echo $PGHead;
						echo "<p>Please enter your username and password to login.<br />&nbsp;<br /><form action=\"unit10.php\"><input class=\"btn-more\" type=\"submit\" value=\"Return to Login\" /></form></p>";
						...
						if ($QYRRow) {
							...
							header('Location:unit10_Admin.php');
						} else {
							session_start();
							$_SESSION['authuser'] = 0;
							echo $PGHead;
							echo "<p>Login invalid.<br />&nbsp;<br /><form action=\"unit10.php\"><input class=\"btn-more\" type=\"submit\" value=\"Return to Login Page\" /></form></p>";
						}
